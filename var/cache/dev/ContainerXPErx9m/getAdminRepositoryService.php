...
{
    /**
     * Gets the private 'App\Repository\Backend\AdminRepository' shared autowired service.
     *
     * @return \App\Repository\Backend\AdminRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Backend'.\DIRECTORY_SEPARATOR.'AdminRepository.php';

        return $container->privates['App\\Repository\\Backend\\AdminRepository'] = new \App\Repository\Backend\AdminRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
