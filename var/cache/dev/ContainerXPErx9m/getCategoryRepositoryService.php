...
{
    /**
     * Gets the private 'App\Repository\Backend\CategoryRepository' shared autowired service.
     *
     * @return \App\Repository\Backend\CategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Backend'.\DIRECTORY_SEPARATOR.'CategoryRepository.php';

        return $container->privates['App\\Repository\\Backend\\CategoryRepository'] = new \App\Repository\Backend\CategoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
