 ...
 */
class getDebug_Security_Firewall_Authenticator_AdminSecuredAreaService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.firewall.authenticator.admin_secured_area' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['debug.security.firewall.authenticator.admin_secured_area'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener(new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener(new \Symfony\Component\Security\Http\Authentication\AuthenticatorManager([0 => ($container->privates['App\\Security\\AdminLoginFormAuthenticator'] ?? $container->load('getAdminLoginFormAuthenticatorService')), 1 => ($container->privates['security.authenticator.remember_me.admin_secured_area'] ?? $container->load('getSecurity_Authenticator_RememberMe_AdminSecuredAreaService'))], ($container->privates['security.token_storage'] ?? $container->getSecurity_TokenStorageService()), ($container->privates['security.event_dispatcher.admin_secured_area'] ?? $container->getSecurity_EventDispatcher_AdminSecuredAreaService()), 'admin_secured_area', ($container->privates['monolog.logger.security'] ?? $container->getMonolog_Logger_SecurityService()), true, true, [])));
    }
}
