...
{
    /**
     * Gets the private 'App\Repository\Backend\UserRepository' shared autowired service.
     *
     * @return \App\Repository\Backend\UserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Backend'.\DIRECTORY_SEPARATOR.'UserRepository.php';

        return $container->privates['App\\Repository\\Backend\\UserRepository'] = new \App\Repository\Backend\UserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
